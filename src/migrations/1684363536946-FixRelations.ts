...
export class FixRelations1684363536946 implements MigrationInterface {
    name = 'FixRelations1684363536946'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "movie_actors_actor" ADD CONSTRAINT "PK_8cc9dd1b97d08d737a6fe06e810" PRIMARY KEY ("movie")`);
        await queryRunner.query(`ALTER TABLE "movie_actors_actor" ADD "actor" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "movie_actors_actor" DROP CONSTRAINT "PK_8cc9dd1b97d08d737a6fe06e810"`);
